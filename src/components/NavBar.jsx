...
const NavBar = () => {
  ...
  return (
    <div className="z-50 flex justify-between lg:justify-around items-center w-full text-white h-20 fixed bg-black">
      <div>
        <h1 className="text-5xl ml-2 font-signature">Mehdi</h1>
      </div>
